...
class ArchivematicaArchiver(BaseArchiver):
    ...
    def __init__(self, sip, data_dir='data/files',
        ...
        """
        super(ArchivematicaArchiver, self).__init__(
    ...
    @staticmethod
    def _get_csv_metadata(sip):
        fac = import_string(current_app.config.get(
    ...
    def get_baginfo_file(self, filesinfo):
        ...
        for t_name, t_value in self.tags:
            if t_name == 'Payload-Oxum':
                ...
                t_value = '{0}/{1}'.format(self.sip.id,
    ...
    def get_all_files(self):
        ...
        if self.patch_of:
            ...
            for uuid in fetched_uuids:
                ...
                # If the file is attached to the new SIP, use the new
                # filepath
    ...
    def write_all_files(self):
        ...
        csv_metadata = self._get_csv_metadata(self.sip)
        pass
